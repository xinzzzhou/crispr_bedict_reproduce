...
if __name__ == '__main__':
    ...
    # load data
    seq_df = pd.read_csv(os.path.join(args.base_dir, 'data/sample_data', 'abemax_sampledata.csv'), header=0)
    ...
    csv_dir = create_directory(os.path.join(args.base_dir, 'data/sample_data', 'predictions'))
